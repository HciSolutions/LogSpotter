...
namespace Triamun.Log4NetViewer.Data
{
    ...
    public class LogEventFilter
    {
        ...
        {
            get { return _classNameRegex == null ? String.Empty : _classNameRegex.ToString(); }
        ...
        {
            get { return _domainRegex == null ? String.Empty : _domainRegex.ToString(); }
        ...
        {
            get { return _exceptionRegex == null ? String.Empty : _exceptionRegex.ToString(); }
        ...
        {
            get { return _fileNameRegex == null ? String.Empty : _fileNameRegex.ToString(); }
        ...
        {
            get { return _loggerRegex == null ? String.Empty : _loggerRegex.ToString(); }
        ...
        {
            get { return _messageRegex == null ? String.Empty : _messageRegex.ToString(); }
        ...
        {
            get { return _threadRegex == null ? String.Empty : _threadRegex.ToString(); }
